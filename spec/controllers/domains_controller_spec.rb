...
describe DomainsController do
  ...
  describe "GET index" do
    it "assigns all domains as @domains" do
      Domain.stub!(:find).with(:all).and_return([mock_domain])
      get :index
  ...
  describe "GET show" do
    it "assigns the requested domain as @domain" do
      Domain.stub!(:find).with("37").and_return(mock_domain)
      get :show, :id => "37"
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created domain as @domain" do
        Domain.stub!(:new).with({'these' => 'params'}).and_return(mock_domain(:save => true))
